...
int main()
{
	...
	codeFrame = pte >> 12; codeFlags = pte & 0x00000FFF;

	get_pte((void *)(dataPage << 12), &pte);
	dataFrame = pte >> 12; dataFlags = pte & 0x00000FFF;

	get_pte((void *)(bssPage << 12), &pte);
	bssFrame = pte >> 12; bssFlags = pte & 0x00000FFF;
